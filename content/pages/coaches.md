...
dek: Experienced coaches who build the programming together, hold
  ...
  sport. Meet the CrossFit coaching staff in Wheat Ridge.
heroCtas:
...
<section class="section">
  <div class="container">
    ...
    <h2 class="section-heading">Collaborative programming, not a template.</h2>
    <div class="grid grid-3 mt-8">
      <div class="card">
        <h3>Programming built together.</h3>
...
<section class="section">
  <div class="container">
    ...
    <div class="grid grid-2 mt-8">
      <div class="card">
        <h3>Megan Markee</h3>
        <p class="text-muted" style="text-transform:uppercase;letter-spacing:0.08em;font-size:0.75rem;font-weight:700;margin-bottom:var(--space-3);color:var(--color-accent-text);">Programming · 2× Semifinalist · 2× Regionals</p>

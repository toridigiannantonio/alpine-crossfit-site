...
title: "What to Expect on Your First Visit — Alpine CrossFit"
description: "What happens on your first visit to Alpine CrossFit in Wheat Ridge: whether you need an appointment, what to bring, how classes are scaled for beginners, and whether you can watch a class first."
canonical: "https://alpinecrossfit.com/what-to-expect/"
eyebrow: "First visit"
...
extraSchemas:
  - {
      ...
      "itemListElement": [
        ...
        {"@type": "ListItem", "position": 2, "name": "What to Expect", "item": "https://alpinecrossfit.com/what-to-expect/"}
      ]
    }
  - {
      "@context": "https://schema.org",
...
<section class="section">
  <div class="container container-narrow">
    <h2>Two different first visits.</h2>
    <p>Which one you're booking changes what the day looks like, so it's worth knowing the difference before you arrive.</p>
    <p>A <strong>free No Sweat Intro</strong> is a conversation, not a class. Thirty minutes with a CF-L2 coach: you'll tour the gym, talk through your goals and training history, and leave with a recommendation. You won't work out, so there's nothing to bring and nothing to be nervous about.</p>
    <p>A <strong>drop-in</strong> is a real class. You'll train alongside members in a coached session, scaled to whatever you can do that day. Drop-ins are $30 and you can <a href="/drop-in/">book and pay online</a> before you arrive.</p>
  </div>
</section>
...
<section class="section">
  <div class="container container-narrow text-center">
    <p class="text-muted">Need the address, hours, or parking? That's all on the <a href="/visit/">Location &amp; Hours</a> page.</p>
  </div>
</section>

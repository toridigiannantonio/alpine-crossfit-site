...
heroCtas:
  - { label: "Not sure where to start?", href: "#book-form", id: "open-popup", style: "btn-primary btn-lg" }
...
finalCta:
  ...
  ctas:
    - { label: "Not sure where to start?", href: "#book-form", inlineStyle: "background:#000;color:#fff;" }
